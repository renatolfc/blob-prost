/****************************************************************************************
** Starting point for running Q algorithm. Here the parameters are set, the algorithm
...
** This is an example for other people to use: Q with Basic Features.
** 
...
int main(int argc, char** argv){
	...
	SeqQLearner sarsaLearner(ale, &features, &param, 2*param.getSeed()-1);
    //Learn a policy:
