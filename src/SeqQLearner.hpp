...
class SeqQLearner : public RLLearner{
private:
    ...
    /**
     * Constructor declared as private to force the user to instantiate SeqQLearner
...
public:
    SeqQLearner(ALEInterface& ale, Features *features, Parameters *param,int seed);
    /**
