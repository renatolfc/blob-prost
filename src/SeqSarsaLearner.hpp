...
class SeqSarsaLearner : public RLLearner{
private:
    ...
    /**
     * Constructor declared as private to force the user to instantiate SeqSarsaLearner
...
public:
    SeqSarsaLearner(ALEInterface& ale, Features *features, Parameters *param,int seed);
    /**
